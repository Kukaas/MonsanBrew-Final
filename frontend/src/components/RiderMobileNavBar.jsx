    ...
    return (
        <nav className="fixed bottom-0 left-0 right-0 z-50 bg-[#232323] border-t border-gray-700 flex justify-around items-center h-16 md:hidden">
            <Link to="/rider/dashboard" className="flex flex-col items-center justify-center text-xs gap-1 px-2 py-1 focus:outline-none group">
                ...
                <span className={isActive('/rider/dashboard', true) ? 'text-[#FFC107] font-bold' : 'text-white'}>Home</span>
            </Link>
            <Link to="/rider/orders-completed" className="flex flex-col items-center justify-center text-xs gap-1 px-2 py-1 focus:outline-none group">
                <CheckCircle size={24} className={isActive('/rider/orders-completed', true) ? 'text-[#FFC107]' : 'text-white group-hover:text-[#FFC107]'} />
                <span className={isActive('/rider/orders-completed', true) ? 'text-[#FFC107] font-bold' : 'text-white'}>Completed</span>
            </Link>
