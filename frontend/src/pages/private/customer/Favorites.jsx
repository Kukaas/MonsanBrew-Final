            ...
            <CustomerLayout>
                <div className="min-h-screen bg-[#232323] flex flex-col items-center justify-center py-10 px-2">
                    <div className="bg-white rounded-2xl shadow-lg flex flex-col items-center justify-center p-10 max-w-md w-full">
                        <Heart size={80} strokeWidth={2.5} className="mb-4" style={{ color: '#FFC107', filter: 'drop-shadow(0 0 8px #FFC10788)' }} />
                        <div className="text-2xl font-extrabold text-[#232323] mb-2 text-center">No favorites yet</div>
                        <div className="text-gray-500 mb-6 text-center">You haven't added any products to your favorites.</div>
                        <Button
                            variant="yellow"
    ...
    return (
        <CustomerLayout>
            <div className="min-h-screen bg-[#232323] flex flex-col items-center py-10 px-2">
                <h1 className="text-4xl font-extrabold text-center text-white mb-8">Favorites</h1>
                        ...
                        favorites.map(product => {
                            ...
                            const QRCodeSVG = (
                                <svg width="120" height="120" viewBox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <text x="50%" y="50%" textAnchor="middle" fill="#FFC107" fontSize="16" dy=".3em">QR</text>
                                </svg>
                            );
                            ...
                            return (
                                <div key={product._id} className="w-[320px] relative">
                                    ...
                                    <div className="absolute top-2 right-2 flex flex-col gap-2 z-10">
                                        <button
                                            onClick={() => { setShareOpen(product._id); setShowQR(false); }}
                                        ...
                                        <button
                                            ...
                                            disabled={unfavoriteMutation.isLoading}
                                            type="button"
                                        >
