...
export default function ViewProduct() {
    ...
    return (
        <AdminLayout>
            <PageLayout title="Product Information" description="See all details for this product.">
                <div className="mb-8 flex items-center gap-4">
                    <Button variant="yellow" size="icon" className="shadow-lg hover:scale-105 transition-transform duration-200" onClick={() => navigate('/admin/products')} >
                ...
                <div className="w-full max-w-7xl mx-auto bg-[#181818]/80 p-12 rounded-3xl border border-[#232323] flex flex-col md:flex-row gap-12 md:gap-20 items-stretch shadow-2xl backdrop-blur-md">
                    ...
                    <div className="flex-shrink-0 flex flex-col items-center md:items-start w-full md:w-[500px]">
                        <div className="relative w-full aspect-[4/3] bg-gradient-to-br from-[#232323] to-[#1a1a1a] rounded-2xl border-4 border-[#FFC107] overflow-hidden flex items-center justify-center shadow-xl group">
                            {product.image ? (
                                ...
                                <span className="text-[#BDBDBD] text-center text-xl">No image</span>
                            )}
                        </div>
                        <div className="mt-8 flex flex-wrap gap-4">
                            <Badge variant={product.isAvailable ? "outline" : "destructive"} className={product.isAvailable ? "border-green-400 text-green-400 px-6 py-2 text-lg font-semibold shadow-md bg-[#1a2e1a]/60" : "border-red-400 text-red-400 px-6 py-2 text-lg font-semibold shadow-md bg-[#2e1a1a]/60"}>
                                {product.isAvailable ? <CheckCircle2 className="w-5 h-5 mr-2" /> : <XCircle className="w-5 h-5 mr-2" />}
                                {product.isAvailable ? "Available" : "Not Available"}
                            </Badge>
                            <Badge variant={product.isCustomizable ? "yellow" : "outline"} className={product.isCustomizable ? "border-[#FFC107] text-black bg-gradient-to-r from-[#FFD600] to-[#FFC107] px-6 py-2 text-lg font-semibold shadow-md" : "border-gray-400 text-gray-400 px-6 py-2 text-lg font-semibold shadow-md"}>
                    ...
                    <div className="flex-1 flex flex-col gap-12 justify-center">
                        {/* Product Info */}
                        <div>
                            <h3 className="text-[#FFC107] text-2xl font-extrabold mb-6 tracking-widest uppercase drop-shadow-lg">Product Info</h3>
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-16 gap-y-5 text-xl">
                                <div>
                        ...
                        {/* Add-ons */}
                        <div>
                            <h3 className="text-[#FFC107] text-2xl font-extrabold mb-6 tracking-widest uppercase drop-shadow-lg">Add-ons</h3>
                        ...
                        {/* Ingredients */}
                        <div>
                            <h3 className="text-[#FFC107] text-2xl font-extrabold mb-6 tracking-widest uppercase drop-shadow-lg">Ingredients</h3>
